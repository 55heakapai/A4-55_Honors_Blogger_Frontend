...
const AddPosts = (props) => {
  ...
  useEffect(()=>{
      axios({
        method: 'get',
        url: 'http://localhost:3001/category/catlist',
        headers: {
  ...
  useEffect(()=>{
      axios({
        method: 'get',
        url: 'http://localhost:3001/author/authlist',
        headers: {
          token: localStorage.getItem('token'),
        },
      })
  ...
  const handleSubmit = (event) => {
    ...
    axios({
      method: 'post',
      url: 'http://localhost:3001/post/addPost',
      data: newPost,
      headers: {
        token: localStorage.getItem('token'),
      },
      ...
      .then(function (response) {
        ...
        axios
          .get('http://localhost:3001/post/postData')
          .then((response) => {
